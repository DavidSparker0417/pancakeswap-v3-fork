...
async function main() {
  ...
  if (networkName === "testnet" || networkName === "mainnet") {
    ...
    const PancakeStableInfoFactory = await ethers.getContractFactory("PancakeStableSwapTwoPoolInfo");
    ...
    console.log("pancakeStableInfo deployed to:", pancakeStableInfoFactory.address);
  }
}
